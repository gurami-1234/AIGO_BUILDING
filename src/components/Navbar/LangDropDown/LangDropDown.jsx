...
export const LangDropDown = () => {
  ...
  return (
    <div className="dropdown">
      <button className="dropdown-toggle" onClick={()=>setIsOpen(true)}>
        <img src={`${process.env.PUBLIC_URL}/images/${language.slug}_flag.png`} alt="" className='lang_image' /> <IoIosArrowDown className='arrow-down' />
      </button>
